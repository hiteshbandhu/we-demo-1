      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <p className="my-6 text-base text-body-color dark:text-dark-6">
                  {contactData.sectionTitle.paragraph}
                </p>
              </div>
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-primary">
                    ...
                    >
                      {/* Use the location icon from JSON or keep a static one */}
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-primary">
                    <svg
                      ...
                      className="fill-current"
                    >
                      {/* Use the help icon from JSON or keep a static one */}
                  ...
                  <div>
                    <h3 className="mb-[18px] text-lg font-semibold text-dark dark:text-white">
                      {contactData.help.title}
                    </h3>
                    <ul>
                      <li>
                        <a
                          href={`mailto:${contactData.help.email1}`}
                          className="text-base text-body-color hover:text-primary dark:text-dark-6"
                        >
                          {contactData.help.email1}
                        </a>
                      </li>
                      <li>
                        <a
                          href={`mailto:${contactData.help.email2}`}
                          className="text-base text-body-color hover:text-primary dark:text-dark-6"
                        >
                          {contactData.help.email2}
                        </a>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="w-full px-4 lg:w-5/12">
            <div className="relative mb-12 max-w-full overflow-hidden rounded-lg">
              {/* Add any necessary styles or features here */}
            </div>
          </div>
        </div>
      </div>
